...
CREATE TABLE IF NOT EXISTS public.generated_images (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY KEY,
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  storage_path TEXT NOT NULL,
  prompt TEXT,
...
-- ═══ MIGRAÇÃO: adicionar colunas de metadados ao generated_images ═══
DO $$ BEGIN
  ALTER TABLE public.generated_images ADD COLUMN IF NOT EXISTS title TEXT;
  ALTER TABLE public.generated_images ADD COLUMN IF NOT EXISTS network TEXT DEFAULT 'instagram';
  ALTER TABLE public.generated_images ADD COLUMN IF NOT EXISTS format TEXT DEFAULT 'post';
  ALTER TABLE public.generated_images ADD COLUMN IF NOT EXISTS caption TEXT;
  ALTER TABLE public.generated_images ADD COLUMN IF NOT EXISTS tone TEXT;
  ALTER TABLE public.generated_images ADD COLUMN IF NOT EXISTS case_type TEXT;
